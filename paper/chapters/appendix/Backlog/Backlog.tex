...
\begin{enumerate}
	\setcounter{enumi}{82} % Give number of the previous number
...
\begin{enumerate}
	\setcounter{enumi}{83} % Give number of the previous number
...
\begin{enumerate}
	\setcounter{enumi}{84} % Give number of the previous number
