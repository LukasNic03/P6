...
\section{Backlog}\label{Appendix_secBacklog}
...
\begin{enumerate}
	\setcounter{enumi}{71} % Give number of the previous number
...
\begin{enumerate}
	\setcounter{enumi}{73} % Give number of the previous number
...
\begin{enumerate}
	\setcounter{enumi}{81} % Give number of the previous number
